...
must be parametrised over the range a sweep will reach before the sweep
rather than after.
...
4 & marginalised & OLS   & 0.962 & $[0.723,\,0.985]$\\
\bottomrule
\end{tabular}
\end{table}
...
carried forward from an earlier Cobb-Douglas core with no labour market and
