...
would shrink the collapse region (\cref{sec:government}), but it \emph{enlarged}
...
\emph{lowered} the viability threshold.
...
not: the loop turns because, at a fixed numéraire, the nominal wage \emph{is} the
