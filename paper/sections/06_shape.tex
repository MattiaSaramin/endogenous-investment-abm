...
channel it displaces. And at \emph{every} elasticity at which the turn is
resolved, the whole range $0.30$ to $1.50$, the anchored retention rate
lies to the \emph{left} of the turn, on the falling branch. The margin is
...
\textbf{The empirical range sits below the frontier.} With $\sigma \in
...
\textbf{Unemployment has a different frontier.} $\sigstar_U \approx
