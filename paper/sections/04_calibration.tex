...
\textbf{(1) Anchored.} There exists an empirical quantity of which the
...
the replacement rate are in this tier. \textbf{(2) Declared convention.} A
...
described as such. $\delta$ is the consequential case. \textbf{(3)
Non-anchorable by decision.} No empirical quantity corresponds to the
