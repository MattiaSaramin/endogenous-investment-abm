...
is endogenous, capital accumulates, labor is hired endogenously, and the wage
...
estimator is about the turn rather than the sign: retention depresses
output while $\rho$ lies below a $\sigma$-dependent threshold $\rhostar$ and
expands it beyond, $\rhostar$ rises with $\sigma$, and the anchored retention
rate lies below $\rhostar$ at every elasticity tested. Summarized
...
replacement rate inside the OECD band eliminates it, making retention
...
The third is the finding to carry forward, and it was not an anticipated one. It
is the wage$\,\to\,$unemployment$\,\to\,$capital-erosion channel, which the wage
curve produced without being sought, killed three consecutive stabilization
...
oscillation that erodes the capital stock, more demand is not a stabilizer,
...
Two boundaries are placed on all three. Marginalized over the full defensible
